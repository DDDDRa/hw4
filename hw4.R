...
DATA_q3between<-as.matrix(data.frame(DATApersonidnew,DATAlogwagenew,constant,DATAeducnew,DATApotenew))
X_q3between<-DATA_q3between[,3:5]
Y_q3between<-DATA_q3between[,2]
beta_q3between<-solve((t(X_q3between)%*%X_q3between))%*%(t(X_q3between)%*%Y_q3between)
print(beta_q3between)
